...
vlrunit1=30 #Valor unitário do produto 1
vlrunit2=40 #Valor unitário do produto 2
vlrunit3=50 #Valor unitário do produto 3
vlrunit4=60 #Valor unitário do produto 4
vlrproduto=vlrunit1+vlrunit2+vlrunit3+vlrunit4#Soma dos valores unitários dos produtos
...
while opcao<=4: 
 ...
 if opcao == 1:
    ...
    print(produtos[1],'- R$',vlrunit1)
    print(produtos[2],'- R$',vlrunit2)
    print(produtos[3],'- R$',vlrunit3)
    print(produtos[4],'- R$',vlrunit4)
